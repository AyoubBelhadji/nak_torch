...
from nak_torch.algorithms import grad_aldi, eks, gradfree_aldi, cbs
import nak_torch
...
def post_log_dens(pts):
    ll_term = model.likelihood_precision * \
        torch.linalg.norm(pts @ obs_op - model.true_obs, dim=1)**2
