...
def animate_trajectories_box(objective_function, trajectories, frame_step, bounds, save_path=None):
    ...
    Z = torch.exp(objective_function(torch.tensor(XY))).detach().numpy().reshape(100, 100)
